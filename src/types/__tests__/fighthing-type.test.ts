...
describe("FightingType", () => {
  const subject = setupTestFor(new FightingType());

  describe(".attackEffectivenessOn", () => {
    subject.testAttackEffectivenessOn(new NormalType(), 2);
  ...
  describe(".defenseEffectivenessOn", () => {
    ...
    subject.testDefendEffectivenessOn(new PsychicType(), 2);
