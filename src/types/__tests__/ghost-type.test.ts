...
describe("GhostType", () => {
  const subject = setupTestFor(new GhostType());

  describe(".attackEffectivenessOn", () => {
    subject.testAttackEffectivenessOn(new NormalType(), 0);
    ...
    subject.testAttackEffectivenessOn(new GhostType(), 2);
    ...
    subject.testAttackEffectivenessOn(new DarkType(), 0.5);
    subject.testAttackEffectivenessOn(new FairyType(), 1);
  });

  describe(".defenseEffectivenessOn", () => {
    subject.testDefendEffectivenessOn(new NormalType(), 0);
    subject.testDefendEffectivenessOn(new FightingType(), 0);
    subject.testDefendEffectivenessOn(new FlyingType(), 1);
    subject.testDefendEffectivenessOn(new PoisonType(), 0.5);
    ...
    subject.testDefendEffectivenessOn(new GhostType(), 2);
    ...
    subject.testDefendEffectivenessOn(new DarkType(), 2);
