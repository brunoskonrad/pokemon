...
describe("GroundType", () => {
  const subject = setupTestFor(new GroundType());
  ...
  describe(".attackEffectivenessOn", () => {
    ...
    subject.testAttackEffectivenessOn(new FlyingType(), 0);
    ...
    subject.testAttackEffectivenessOn(new ElectricType(), 2);
  ...
  describe(".defenseEffectivenessOn", () => {
    ...
    subject.testDefendEffectivenessOn(new ElectricType(), 0);
