...
describe("PsychicType", () => {
  const subject = setupTestFor(new PsychicType());

  describe(".attackEffectivenessOn", () => {
    subject.testAttackEffectivenessOn(new NormalType(), 1);
    subject.testAttackEffectivenessOn(new FightingType(), 2);
    subject.testAttackEffectivenessOn(new FlyingType(), 1);
    subject.testAttackEffectivenessOn(new PoisonType(), 2);
    ...
    subject.testAttackEffectivenessOn(new PsychicType(), 0.5);
    subject.testAttackEffectivenessOn(new IceType(), 1);
    subject.testAttackEffectivenessOn(new DragonType(), 1);
    subject.testAttackEffectivenessOn(new DarkType(), 0);
