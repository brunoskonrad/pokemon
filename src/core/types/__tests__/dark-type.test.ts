...
describe("DarkType", () => {
  const subject = setupTestFor(new DarkType());
  ...
  describe(".defenseEffectivenessOn", () => {
    ...
    subject.testDefendEffectivenessOn(new GhostType(), 0.5);
    ...
    subject.testDefendEffectivenessOn(new PsychicType(), 0);
    subject.testDefendEffectivenessOn(new IceType(), 1);
    subject.testDefendEffectivenessOn(new DragonType(), 1);
    subject.testDefendEffectivenessOn(new DarkType(), 0.5);
    subject.testDefendEffectivenessOn(new FairyType(), 2);
  });
});
