...
describe("FairyType", () => {
  const subject = setupTestFor(new FairyType());
  ...
  describe(".attackEffectivenessOn", () => {
    ...
    subject.testAttackEffectivenessOn(new DragonType(), 2);
  ...
  describe(".defenseEffectivenessOn", () => {
    ...
    subject.testDefendEffectivenessOn(new SteelType(), 2);
    ...
    subject.testDefendEffectivenessOn(new DragonType(), 0);
